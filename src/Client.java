...
public class Client {
	...
	//Fait un programme de restaurant. Alors un restaurant à plusieurs menus et plusieurs plat avec des prix . Un client peut prendre un ou plusieurs plat ou menu. Il peut aussi prendre une boisson et dessert. A la fin bien entendu on lui donne l'addition et lui il paye en espèce.  Si il a pas assez on lui fait faire la plonge , si il a le compte on lui dit aurevoir et si il a trop on lui donne la monnaie et aurevoir
//	Ce petit projet va te faire utiliser 2 classe minimum restaurant et client (mais tu peux faire comme tu veux comme rajouter les classes menu et plat) le nombre de classe , de propriété sont à ta charge , tu es libre de faire ce que tu veux
